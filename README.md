...
In the end, the algorithm could effortlessly beat me. It could also beat simpler algorithms that just look at the number of black pieces minus the number of white pieces up to a depth of 11+. It is hence very successful as it is powerful yet very time-efficient. 
