...
public class Board {
	...
	/*
	 * Returns who has more pieces --> Counts how many white and black pieces there are. 
	 * It returns the black pieces subtracted by the white pieces.
	 */
	public int whoHasMorePieces(int[][] board) {
		int white = 0;
		int black = 0;
		for (int i = 0; i < board.length; i++) {
			for (int j = 0; j < board[0].length; j++) {
